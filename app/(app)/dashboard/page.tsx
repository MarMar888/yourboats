...
export default async function DashboardPage() {
  ...
  // Fetch today first; if none, fetch this week
  ...
  // For owner/manager: group by assigned employee (or "Unassigned")
  // For employee: flat list (all services in dev mode — real auth will filter)
  ...
  function toCardProps(svc: ServiceData): JobCardProps {
    return {
      ...
      boats: svc.boats,
      canComplete: true, // dev mode: everyone can complete; real auth will scope this
    }
  }
  ...
  return (
    <div>
      ...
      {displayServices.length === 0 ? (
        ...
        // Owner/Manager: group by assigned employee
...
function OwnerManagerView({
  ...
  // Build a map: assignee label → services
  // A service can appear in multiple groups if multiple employees are assigned.
  // If no assignments, it goes under "Unassigned".
