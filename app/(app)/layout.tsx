...
import { LiveClockInsProvider, LiveClockInsPanel, LiveClockInsWidget } from '@/components/live-clock-ins'
...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider>
      <LiveClockInsProvider entries={activeClockins}>
